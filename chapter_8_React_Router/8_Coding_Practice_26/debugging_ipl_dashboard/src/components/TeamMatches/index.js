import {Component} from 'react'
 import {Oval} from 'react-loader-spinner' // Correct import for specific loader
...
class TeamMatches extends Component {
    ...
    return (
      <ul className="recent-matches-list">
        {recentMatches.map(recentMatch => (
          <MatchCard key={recentMatch.id} matchData={recentMatch} />
        ))}
      </ul>
    )
  }
  ...
  renderTeamMatches = () => {
    ...
    return (
      <div className="team-matches-container">
        ...
        <LatestMatch key={id} latestMatchData={latestMatch} />
  ...
  renderLoader = () => (
    <div testid="loader" className="loader-container">
      <Oval color="#ffffff" height={50} width={50} /> {/* Correct usage */}
    </div>
  )
  // renderLoader = () => (
